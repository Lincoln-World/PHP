...
<html lang="en">
    ...
    <body>
        ...
        ?> -->
            <form  action="processes/authenticationProcess.php" method="post">
                <input type="email" name="email" placeholder="Enter email"  class="form-control">
                <p class="">Already signed up ? <a href="login.php">SignIn</a></p>
                <button type="submit" name="register" class="btn btn-primary mt-5">SignUp</button>
            </form>
        </div>
    </body>
</html>